...
(function (global, factory) {
  ...
  function FlatpickrInstance(element, instanceConfig) {
    ...
    function bindEvents() {
      ...
      if (window.ontouchstart !== undefined) bind(window.document, 'click', documentClick);
          ...
          case 39:
            if (!isTimeObj) {
              ...
              if (self.daysContainer !== undefined && (allowInput === false || isInView(document.activeElement))) {
                ...
                if (!e.ctrlKey) focusOnDay(undefined, _delta);
                else {
                  changeMonth(_delta);
    ...
    function set(option, value) {
      if (option !== null && typeof option === 'object') Object.assign(self.config, option);
      else {
  ...
  var flatpickr = function flatpickr(selector, config) {
    ...
    else if (typeof selector === 'string') return _flatpickr(window.document.querySelectorAll(selector), config);
